...
export const init = () => {
  ...
  const initOneLink = () => {
    ...
    partnerScript.src = '//1l-hit.my.games/v1/hit/104482.js?r=' + encodeURIComponent(document.referrer) + '&l=' + encodeURIComponent(window.location.href) + '&u=' + encodeURIComponent(0) + '&rnd=' + Math.random();
