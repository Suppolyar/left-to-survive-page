<template>
  <div class="flex flex-col overflow-hidden ">
    <div
      class="relative logo-screen:h-full h-screen w-screen overflow-hidden bg-lts-bg bg-cover bg-top bg-no-repeat"
    >
      ...
      >
        ...
        <InfoBlock size="medium" class="text-black text-base mt-10">
